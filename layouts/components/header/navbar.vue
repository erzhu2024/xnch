<template>
    <nav>
        <Menu class="navbar" :menu="menu" :default-active="activeMenu" mode="horizontal">
            <template #item="{ item }">
                <menu-item v-if="!item.component" :menu-item="item" :route-path="item.path" />
                <div v-else>
                    ...
                    <template v-if="item.component == 'about'">
                        <About :menu-item="item" />
                    </template>
